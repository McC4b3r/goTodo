...
import (
	...
	"github.com/mcc4b3r/go_app/server/config"
	"github.com/mcc4b3r/go_app/server/handlers"
	"github.com/mcc4b3r/go_app/server/storage"
	"github.com/mcc4b3r/go_app/server/storage/postgres"
	"github.com/rs/cors"
...
var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start and serve the go_app api",
...
func registerServices() {
	var apiServer go_appv1.ApiServer = &handlers.ApiServer{}
	go_appv1.RegisterApiServer(Server.Server, apiServer)
}
...
func runGateway() {
	...
	err := go_appv1.RegisterApiHandlerFromEndpoint(context.Background(), mux, grpcAddress, opts)
